...
Use it after `ag-review` or `ag-violation-detection` has produced approved refactor tasks, or when a Constitution Update Proposal should be reflected in design or task artifacts (e.g., `plan.md`, `design.md`, `tasks.md`).
