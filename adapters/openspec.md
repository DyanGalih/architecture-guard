...
Use this adapter when the active SDD framework is **OpenSpec** (`openspec/config.yaml` detected).
...
| extensions-dir | Unsupported; do not probe a framework extension directory |
